...
public final class NoFall extends Module {
    private final NumberSetting fallDist = register(new NumberSetting("Fall Dist", "Min fall dist to activate", 3, 1, 20, 0.5));
    ...
    public void onTick(TickEvent e) {
        ...
        if (mc.player.fallDistance >= fallDist.floatValue())
